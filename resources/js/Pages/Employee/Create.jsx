            ...
            <div className='max-w-4xl mx-auto'>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded-md shadow-md">
                    ...
                    <div>
                        ...
                        />
                        {errors.first_name && (
                            <p className="mt-2 text-red-500 text-sm">{errors.first_name}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.last_name && (
                            <p className="mt-2 text-red-500 text-sm">{errors.last_name}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.hire_date && (
                            <p className="mt-2 text-red-500 text-sm">{errors.hire_date}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.birth_date && (
                            <p className="mt-2 text-red-500 text-sm">{errors.birth_date}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        {errors.dept_no && (
                            <p className="mt-2 text-red-500 text-sm">{errors.dept_no}</p>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        />
                        {errors.photo && (
                            <p className="mt-2 text-red-500 text-sm">{errors.photo}</p>
                        )}
                    </div>
