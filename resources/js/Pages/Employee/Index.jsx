        ...
        <div className="p-8 bg-gray-100 min-h-screen">
            ...
            <div className='grid grid-cols-2 gap-5 mb-6'>
                <form onSubmit={handleSearch} className="flex items-center gap-4">
                    ...
                    <button
                        type="submit"
                        className="px-6 py-2 bg-gray-700 text-white font-semibold rounded-md shadow-md hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                        Search
                    </button>
                </form>
                <Link href='employee/create'
                    className="px-6 py-2 bg-blue-500 text-white font-semibold rounded-md shadow-md flex items-center justify-center hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                    Create
                </Link>
            </div>
                            ...
                            <tr key={index} className="hover:bg-gray-100">
                                ...
                                <td className="px-6 py-4 text-sm text-gray-700">
                                    {employee.photo_path ? (
                                        ...
                                        <img
                                            src="/storage/Photos/noPhoto.jpg"
                                            alt='No Photo'
                                            className="w-12 h-12 rounded-full object-cover"
                                        />
                                    )}
